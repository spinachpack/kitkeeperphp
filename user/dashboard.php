...
<body>
    <div class="sidebar">
        <div class="profile-section">
            <img src="<?= getProfilePicture($_SESSION['profile_picture']) ?>" class="profile-img" alt="Profile">
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                                        ...
                                        <?php while ($booking = $reservations->fetch_assoc()): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <span
                                                        class="badge <?php echo $badge_class[$booking['status']]; ?> badge-status">
                                                ...
                                                <div class="modal fade" id="bookingModal<?php echo $booking['id']; ?>"
                                                    tabindex="-1">
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title">Booking Details
                                                                    #<?php echo $booking['id']; ?></h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <p><strong>Start:</strong>
                                                                            <?php echo date('F d, Y h:i A', strtotime($booking['start_date'] . ' ' . $booking['start_time'])); ?>
                                                                        </p>
                                                                        <p><strong>End:</strong>
                                                                            <?php echo date('F d, Y h:i A', strtotime($booking['end_date'] . ' ' . $booking['end_time'])); ?>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                <hr>
                                                                <h6>Purpose of Use</h6>
                                                                <p><?php echo nl2br(htmlspecialchars($booking['purpose'])); ?>
                                                                </p>
                                                                ...
                                                                <hr>
                                                                <p><small class="text-muted">Submitted on:
                                                                        <?php echo date('F d, Y h:i A', strtotime($booking['created_at'])); ?></small>
                                                                </p>
                                                            </div>
                        ...
                        <?php else: ?>
                            <p class="text-center text-muted py-4">No bookings yet. <a href="browse_equipment.php">Browse
                                    equipment</a> to make your first reservation.</p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                        ...
                        <?php if ($notifications->num_rows > 0): ?>
                            <?php while ($notif = $notifications->fetch_assoc()): ?>
                                <div class="alert alert-light mb-2 <?php echo $notif['is_read'] ? '' : 'border-primary'; ?>">
                                    <small
                                        class="d-block text-muted"><?php echo date('M d, h:i A', strtotime($notif['created_at'])); ?></small>
