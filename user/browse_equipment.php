                    ...
                    <div class="col-md-4 mb-4">
                        <div class="equipment-card">
                            <?php if (!empty($equip['image'])): ?>
                                <img src="<?php echo BASE_URL . EQUIPMENT_UPLOAD_DIR . $equip['image']; ?>" class="equipment-image"
                                    alt="<?php echo htmlspecialchars($equip['name']); ?>">
                            <?php else: ?>
                            ...
                            <div class="p-3">
                                <span
                                    class="badge bg-primary mb-2"><?php echo htmlspecialchars($equip['category_name']); ?></span>
