            ...
            <?php while ($booking = $bookings->fetch_assoc()): ?>
                <div class="booking-card">
                    <div class="row align-items-center">
                        <div class="col-md-2">
                            <div
                                style="width: 80px; height: 80px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 10px; display: flex; align-items: center; justify-content: center;">
                        ...
                        <div class="col-md-2">
                            ...
                            <p class="mb-0 mt-2">
                                <small class="text-muted">Requested:
                                    <?php echo date('M d, Y', strtotime($booking['created_at'])); ?></small>
                            </p>
                        </div>
                        <div class="col-md-1">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>Name:</strong> <?php echo htmlspecialchars($booking['equipment_name']); ?>
                                        </p>
                                ...
                                <p><small class="text-muted">Submitted on:
                                        <?php echo date('F d, Y h:i A', strtotime($booking['created_at'])); ?></small></p>
                            </div>
