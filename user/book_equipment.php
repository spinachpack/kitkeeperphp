                ...
                <div class="card">
                    <div class="card-body">
                        <?php if (!empty($equipment['image'])): ?>
                            <img src="<?php echo BASE_URL . EQUIPMENT_UPLOAD_DIR . $equipment['image']; ?>"
                                class="equipment-image mb-3" alt="<?php echo htmlspecialchars($equipment['name']); ?>">
                        <?php else: ?>
                        ...
                        <span
                            class="badge bg-primary mb-2"><?php echo htmlspecialchars($equipment['category_name']); ?></span>
                    ...
                    <div class="card-body">
                        <form method="POST">
                            ...
                            <div class="alert alert-info">
                                ...
                                <strong>Note:</strong> Your booking request will be reviewed by an administrator. You
                                will receive a notification once it's approved or rejected.
                            </div>
