                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <p><strong>Equipment:</strong> <?php echo htmlspecialchars($booking['equipment_name']); ?>
                            </p>
                            <p><strong>Start:</strong>
                                <?php echo date('M d, Y h:i A', strtotime($booking['start_date'] . ' ' . $booking['start_time'])); ?>
                            </p>
                            <p><strong>End:</strong>
                                <?php echo date('M d, Y h:i A', strtotime($booking['end_date'] . ' ' . $booking['end_time'])); ?>
                            </p>
                        </div>
                    </div>
                    <hr>
                    ...
                    <?php if (!empty($booking['admin_notes'])): ?>
                        ...
                        <p><small class="text-muted">Reviewed by:
                                <?php echo $booking['admin_first'] . ' ' . $booking['admin_last']; ?> on
                                <?php echo date('M d, Y', strtotime($booking['approved_at'])); ?></small></p>
                    <?php endif; ?>
                    ...
                    <?php if ($booking['status'] === 'approved'): ?>
                        ...
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle"></i> Equipment has been borrowed. Mark as returned when the user
                            returns it.
                        </div>
                        <form method="POST">
                            <input type="hidden" name="booking_id" value="<?php echo $booking['id']; ?>">
